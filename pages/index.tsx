...
const features2 = [
	{
		name: "Location",
		description:
			"Peppermint can be hosted anywhere, with all of the core features available without the need to access the Internet.",
		icon: GlobeEuropeAfricaIcon,
	},
	{
		name: "Data Ownership & Privacy",
		description:
			"Peppermint never transfers any customer app data to our servers. All data is stored locally on your server.",
		icon: LockClosedIcon,
	},
	{
		name: "Lightweight",
	...
	},
	{
		name: "Customer First",
		description:
			"Peppermint is developed with the customer in mind, allowing us to create the best product possible by listening to what our customers actually need.",
		icon: UserIcon,
	},
];
				...
				<div className="mx-auto max-w-2xl pb-32 pt-20">
					<div className="text-center">
						...
						<p className="mt-6 text-lg leading-8 text-gray-600">
							In a world of ever-growing costs, the self-hosted
							and easy to setup Peppermint is here to help.
						</p>
				...
				<div className="mx-auto max-w-7xl px-6 lg:px-8">
					<div className="mx-auto max-w-2xl lg:text-center">
						...
						<p className="mt-6 text-lg leading-8 text-gray-300">
							A central dashboard to your helpdesk allows for a
							complete picture of each customer so you can offer
							the right support.
						</p>
					</div>
				...
				<div className="mx-auto max-w-7xl px-6 lg:px-8">
					<div className="mx-auto max-w-2xl lg:mx-0">
						...
						<p className="mt-2 text-lg leading-8 text-gray-600">
							Some excellent videos that show an overview of
							Peppermint and its features.
						</p>
					</div>
			...
			<div className="bg-gray-900 py-24 sm:py-32">
				<div className="mx-auto max-w-7xl px-6 lg:px-8">
					<div className="mx-auto max-w-2xl lg:mx-0">
						...
						<p className="mt-6 text-lg leading-8 text-gray-300">
							Peppermint is a solution to the ever-growing cost in
							today's corprate world. Think of us as the Costco of
							helpdesk software.
						</p>
					</div>
					<dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 text-gray-300 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-16">
						{features2.map((feature) => (
							<div
								key={feature.name}
								className="relative pl-9 flex-col flex"
							>
						...
						<div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
							<div className="lg:w-full lg:max-w-2xl lg:flex-auto">
								<p className="text-xl leading-8 text-gray-600">
									We've set out to bridge the gap between
									features and cost. Peppermint seeks to offer
									a robust and comprehensive array of tools,
									functionality, and user experience without
									the burden of exorbitant expenses.
								</p>
								<p className="mt-10 max-w-xl text-base leading-7 text-gray-700">
									The project's ethos lies in empowering users
									by providing a platform that doesn't
									compromise on quality and usability while
									maintaining a reasonable cost structure.
									This approach fosters inclusivity, allowing
									individuals and organizations with varying
									budgetary constraints to benefit from a
									feature-rich software solution without
									sacrificing performance or breaking the
									bank.
								</p>
							</div>
					...
					<div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
						<div className="lg:pr-8 lg:pt-4">
							<div className="lg:max-w-lg">
								...
								<p className="mt-6 text-lg leading-8 text-gray-300">
									Peppermint is built to be hosted in a Docker
									container, which can be easily scaled
									through k8's. Alternatively, you can easily
									host Peppermint through pm2 or locally with
									NodeJS
								</p>
								<dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-300 lg:max-w-none">
									<div className="relative pl-9">
										...
										<dd className="">
											Linode is a great cloud provider
											that offers the installation of
											Peppermint through the click of a
											button.
										</dd>
									</div>
								</dl>
								<dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-300 lg:max-w-none">
									<div className="relative pl-9">
										...
										<dd className="">
											Hostinger VPS offers peak
											performance with AMD CPUs, NVMe
								...
								<dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-300 lg:max-w-none">
									<div className="relative pl-9">
										...
										<dd className="">
											Roqitt Hosting offers lightning fast
											& secure SSD web hosting. The
											UK-based enterprise offers
											Peppermint through their new
					...
					<div className="xl:grid xl:grid-cols-3 xl:gap-8">
						<div className="space-y-8">
							...
							<p className="text-sm leading-6 text-gray-600">
								Aiming to bridge the gap between features and
								cost.
							</p>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
					...
					<div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
						<p className="text-xs leading-5 text-gray-500">
							&copy; 2024 Peppermint Labs Ltd. All rights
